...
//	String myMsg = "";
	...
	/*	getSupportActionBar().hide();*/
		...
		PentagonMapsActivity m = new PentagonMapsActivity();
...
*/
	...
	//	vibe = (Vibrator) PentagonActivity.this.getSystemService(Context.VIBRATOR_SERVICE);
...
//				vibe.vibrate(80);
		...
		track.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent map = new Intent(getApplicationContext(), PentagonMapsActivity.class);
				startActivity(map);
			}
